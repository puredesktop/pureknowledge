# Develop pureknowledge and build new apps
...
| Goal | Start here |
| --- | --- |
| Add a feature to pureknowledge | Fork or clone this repository and prepare its shared dependencies, or select its editable project in purefactory when available. |
...
1. Fork [puredesktop/pureknowledge](https://github.com/puredesktop/pureknowledge) if you want your own repository, then clone your fork locally. Create a branch for your change.
